...
```{r}
diff.START <- Diff4SynDataSets(START.dir.root)

diff.START

diff.sa.primary <- Diff4SynDataSets(sa.primary.dir.root)

diff.sa.primary

diff.sa.secondary <- Diff4SynDataSets(sa.secondary.dir.root)

diff.sa.secondary

diff.sp <- Diff4SynDataSets(sp.dir.root)
