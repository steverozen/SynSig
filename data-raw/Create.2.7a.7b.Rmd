...
print(
  system(
    "diff -rq tmp.syn.2.7a.7b.bladder.and.melanoma long.test.regression.data/syn.2.7a.7b.bladder.and.melanoma"))

print(
  system(
    "diff -rq tmp.syn.2.7a.7b.abst long.test.regression.data/syn.2.7a.7b.abst"))
