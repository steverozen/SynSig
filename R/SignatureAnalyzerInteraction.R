...
#'
#' @param overwrite If TRUE overwrite pre-existing results.
#'
...
#'  files generated by SignatureAnalyzer.
#'
#' @param mc.cores Number of cores to use; ignored on
#' Windows.
#'
...
SignatureAnalyzerOneCatalog <-
  function(num.runs,
    ...
    if (FALSE) {
      for (i in 1:num.runs) { # Replace this with "spawning" parallel workers
...
#'
#' @param overwrite if TRUE overwrite pre-exising results
#'
#' @export
#'
