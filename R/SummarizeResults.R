  ...
  function(third.level.dir,
    ...
    retval <-
      SummarizeSigOneSubdir(
        ...
        plot.png.fn = ifelse(write.png, PlotCat96, NA),
    ...
    copy.from <- paste0(third.level.dir,"/SBS96/All_Solution_Layer/L1/stability.pdf")
  ...
  function(third.level.dir,
    ...
    retval <-
      SummarizeSigOneSubdir(
        ...
        plot.png.fn = NA) # Does not exist for COMPOSITE
