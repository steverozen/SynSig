---
title: "Generate cross-matched SignatureAnalyzer and SigProfiler synthetic data to explore handling overlapping / interfering signatures"
author: "Steve Rozen"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Generate cross-matched SignatureAnalyzer and SigProfiler synthetic data to explore handling overlapping / interfering signatures}
...
```{r}
SetNewOutDir("../../Xsyn.2.7a.7b.bladder.and.melanoma.v8/")
```
...
```{r}
SetNewOutDir("../../Xsyn.2.7a.7b.abst.v8/")
set.seed(55)
num.syn.tumors <- 1000
```
