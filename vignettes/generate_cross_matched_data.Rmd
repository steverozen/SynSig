...
```{r}
out.data.dir <<- "syn_sbs3_5_40/"  # Must be a directory; be sure to end in "/"
set.seed(191905)
num.syn.tumors <- 500
...
WriteCat96(sa.sa.96, OutDir("sa.96.RCC.and.OVA.syn.data.csv"))
```
...
## Pull out only 3, 5, 40 and make a new data set.
