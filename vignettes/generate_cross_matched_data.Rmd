...
```{r}
kidney.RCC <- grep("Kidney-RCC", colnames(sa.no.hyper.real.exposures), fixed = TRUE)
...
GenerateSynFromReal <- function(real.exp, num.syn.tumors, file.prefix) {
  ...
  WriteSynSigParams(parms - check.params, parm.file, append = TRUE)
...
```
TODO Next: match the signature profiles and generate full catalogs
