...
```{r}
SetNewOutDir("../../syn.3.5.40.rcc.and.ovary.v3/")
```
...
```{r}
SetNewOutDir("../../syn.3.5.40.abst.v3/")
set.seed(44)
num.syn.tumors <- 1000

sp.abst.info <-
  GenerateSynAbstract(
    x.sp.parms, num.syn.tumors, "sp.3.5.40.abst.", "SP.Syn.Abst")

sa.abst.info <-
  GenerateSynAbstract(
    x.sa.parms,
    num.syn.tumors, "sa-3-5-40-abst-", "SA.Syn.Abst")
